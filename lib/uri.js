 ...
 * @returns {URI} A new valid and fro jolicoin instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'jolicoin:') {
    throw new TypeError('Invalid jolicoin URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid jolicoin address');
  }
